...
def create_layout(cal_date):
    ...
    def date_judgement(i, day):
        if day == today:
            return sg.Text(day.day, size=(16,3), justification='right', text_color='white', background_color='gray')
        elif i == 0 and day.month == cal_date.month:
            return sg.Text(day.day, size=(16,3), justification='right', text_color='red')
        elif i == 6 and day.month == cal_date.month:
            return sg.Text(day.day, size=(16,3), justification='right', text_color='blue')
        elif day.month == cal_date.month:
            return sg.Text(day.day, size=(16,3), justification='right')
        elif i == 0:
            return sg.Text(day.day, size=(16,3), justification='right', text_color='#ff9999')
        elif i == 6:
            return sg.Text(day.day, size=(16,3), justification='right', text_color='#9999ff')
        else:
            return sg.Text(day.day, size=(16,3), justification='right', text_color='#cccccc')
